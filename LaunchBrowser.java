...
public class LaunchBrowser {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("VijayaDharanya");// enter First Name
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("N");// enter Last Name
		// dropdown
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Viji");// enter Local Name
		driver.findElement(By.name("departmentName")).sendKeys("IT");// enter Department
		driver.findElement(By.name("description")).sendKeys("Automation Tester");// Enter description
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("vijayadharanya75@gmail.com");// Enter E-mail
																										// id
