...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("VijayaDharanya");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("vijayadharanya74@gmail.com");
